...
\begin{center}
    ...
    \vspace*{3cm}
    \Large{Alessandro Wagner Palmeira}
    

    \vspace{3cm}
    \textbf{\Large{Sistema de Transcrição Melódica em Tempo Real}}
...
%    $[$ Cosupervisor: Adriano Brito Mitre $]$
...
\input cap-fundamentos        % associado ao arquivo: 'cap-fundamentos.tex'
\input cap-historico        % associado ao arquivo: 'cap-historico.tex'
\input cap-asymut        % associado ao arquivo: 'cap-asymut.tex'
\input cap-temporeal        % associado ao arquivo: 'cap-temporeal.tex'
\input cap-gui        % associado ao arquivo: 'cap-gui.tex'
